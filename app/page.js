      ...
      <div className="p-8 mx-auto max-w-2xl">
        <div className="p-8 mt-8 rounded-xl shadow-lg backdrop-blur-xs bg-black/40">
          <h1 className="mb-4 text-3xl font-bold tracking-widest text-white">
            Welcome to ShapeCraft Survivors
          </h1>
          <p className="text-xl tracking-tight text-slate-200">
            2D rouguelike survival game where players unleash chaos in a relentless bullet firestorm to fend off endless waves of enemies while upgrading weapons used from on-chain assets living on Craft L2.
          </p>
