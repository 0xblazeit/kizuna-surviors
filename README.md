...
I've also removed the token gated access to the game, and now using NFT(s) as in game boost / assets. I figured best to open the game to everyone to get the most feedback, and reward users for holding certain NFTs by making them available as in game assets.
